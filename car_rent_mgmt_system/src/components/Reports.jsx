...
const Reports = () => {
    ...
    const customerReportRefs = useRef({});
    const feedbackReportRef = useRef();
    ...
    const downloadReport = (userId = null) => {
        const element = userId
            ? customerReportRefs.current[userId]
            : feedbackReportRef.current;
        ...
        const opt = {
            margin: 0.5,
            filename: userId
                ? `Customer_Report_${userId}.pdf`
                : `All_Feedbacks_Report.pdf`,
            image: { type: 'jpeg', quality: 0.98 },
            html2canvas: { scale: 2 },
            jsPDF: { unit: 'in', format: 'letter', orientation: 'portrait' }
        };
            ...
            {activeTab === 'customers' && (
                <>
                    ...
                    {users.map((customer) => {
                        ...
                        return (
                            <div key={customer.userId} className="card mb-5 shadow border border-primary">
                                <div className="card-body" ref={el => customerReportRefs.current[customer.userId] = el}>
                                    <div className="d-flex justify-content-between flex-wrap mb-3">
                                        <div className="d-flex align-items-center">
                                            <div className="rounded-circle bg-primary text-white d-flex justify-content-center align-items-center me-3"
                                                style={{ width: '45px', height: '45px', fontSize: '1.1rem' }}>
                                        ...
                                        <div className="text-end mt-3 mt-md-0">
                                            ...
                                            <button className="btn btn-sm btn-outline-success" onClick={() => downloadReport(customer.userId)}>
                                                <i className="bi bi-download me-1"></i>Print Report
                                            </button>
                                        </div>
                                    </div>
                                    <hr />
            ...
            {activeTab === 'all-feedbacks' && (
                <div ref={feedbackReportRef} className="card shadow border border-warning">
                    <div className="card-body">
                        ...
                        <button onClick={() => downloadReport()} className="btn btn-warning mt-3">
                            <i className="bi bi-download me-2"></i>Download Feedback Report
                        </button>
                    </div>
                </div>
            )}
